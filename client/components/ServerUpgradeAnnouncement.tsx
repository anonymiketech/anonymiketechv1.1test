...
export default function ServerUpgradeAnnouncement() {
  ...
  // Rotate through features every 2 seconds
  useEffect(() => {
          ...
          <div className="relative z-10">
            ...
            <div className="flex flex-col lg:flex-row items-center gap-6">
              ...
              <div className="flex-1 text-center lg:text-left space-y-4">
                ...
                >
                  Server upgrade complete! Experience blazing-fast VPN speeds,
                  enhanced security, and rock-solid reliability like never
                  before.
                </motion.p>
                ...
                <AnimatePresence mode="wait">
                  ...
                  >
                    ...
                    >
                      {React.createElement(
                        upgradedFeatures[currentFeature].icon,
                        {
                          className: "w-6 h-6",
                        },
                      )}
                    ...
                    <span
                      className={`font-tech font-bold text-lg ${upgradedFeatures[currentFeature].color}`}
                    >
