...
export default function VPNPackageModal({ 
  isOpen, 
  onClose, 
  packageData, 
  onAddToCart 
}: VPNPackageModalProps) {
  ...
  const handleWhatsAppOrder = () => {
    const message = `🔒 VPN SERVICE INQUIRY\\n\\n` +
        ...
        >
          ...
          <div className="flex items-start justify-between mb-6">
            <div className="flex items-center gap-3">
              <div className="text-4xl">
                {packageIcons[packageData.id as keyof typeof packageIcons] || "🔒"}
              </div>
              <div>
          ...
          <div className="bg-hacker-bg/50 rounded-lg p-6 mb-6 text-center">
            {packageData.hasDiscount && packageData.originalPrice ? (
              ...
              <div className="flex items-center justify-center gap-2">
                <span className="text-5xl font-tech font-bold text-hacker-green">
                  {packageData.price}
                </span>
