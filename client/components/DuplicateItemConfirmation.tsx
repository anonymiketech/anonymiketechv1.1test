        ...
        >
          ...
          >
            ...
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                <h3 className="text-xl font-tech font-bold text-yellow-400">
              ...
              <button
                onClick={handleCancel}
                className="ml-auto p-1 hover:bg-hacker-green/20 rounded transition-colors"
              >
            ...
            <div className="mb-6">
              ...
              <div className="bg-yellow-900/20 border border-yellow-500/30 rounded-lg p-4">
                ...
                <p className="text-yellow-200 text-sm font-tech leading-relaxed">
                  ...
                  subscriptions of the same plan. Each subscription will be billed separately and 
                  run concurrently.
                </p>
              </div>
            </div>
            ...
            <div className="mb-6">
              <label className="flex items-start gap-3 cursor-pointer group">
                <div className="relative mt-1">
                  ...
                  >
                    {isConfirmed && (
                      <Check className="w-3 h-3 text-hacker-bg m-0.5" />
                    )}
                  </div>
                </div>
                <span className="text-hacker-green-bright font-tech text-sm leading-relaxed">
                  ✅ Yes, I understand I'm purchasing an additional subscription 
                  of the same plan and want to proceed with multiple active subscriptions.
                </span>
              </label>
            </div>
