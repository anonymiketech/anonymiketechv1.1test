...
export default function ClientConnectionStats() {
  ...
  // Simulate real-time client connections
  useEffect(() => {
    const updateStats = () => {
      // Generate realistic client connection numbers
    ...
    // Update every 3-5 seconds for realistic simulation
      ...
      <div className="container mx-auto px-4">
            ...
            >
              ...
              <div className="relative z-10">
                <div className="flex items-center justify-between mb-3">
                  <div className={`${stat.color} group-hover:animate-pulse`}>
                    {stat.icon}
                  </div>
                  {stat.pulse && (
                    <motion.div
                ...
                <motion.div
                  key={stat.value} // Key ensures animation on value change
                ...
                <div className="text-sm font-tech text-hacker-green-dim">
                  {stat.label}
                </div>
              </div>
        ...
        >
          <div className="inline-flex items-center gap-2 bg-hacker-terminal/50 backdrop-blur-sm border border-hacker-green/20 rounded-full px-4 py-2">
            ...
            />
            <span className="text-sm font-tech text-hacker-green-bright">
              Server Status: 
            </span>
            <motion.span
        ...
        >
          ...
          <div className="text-center mt-2">
            <span className="text-xs font-tech text-hacker-green-dim">
              Uptime: 99.94% • Latency: &lt;15ms
            </span>
          </div>
        </motion.div>
      </div>
