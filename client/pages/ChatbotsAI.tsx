  ...
  const useCases = [
    {
      ...
      description: "Automate order tracking, product recommendations, and customer service",
      features: ["Order Status Updates", "Product Recommendations", "Payment Assistance", "Returns & Refunds"],
    },
    {
      title: "Lead Generation",
      description: "Capture and qualify leads automatically through intelligent conversations",
      features: ["Lead Qualification", "Contact Collection", "Appointment Booking", "Follow-up Automation"],
    },
    {
      title: "Educational Assistant",
      description: "Provide instant answers and learning support for students",
      features: ["Course Information", "Assignment Help", "Study Schedules", "Progress Tracking"],
    },
    {
      title: "Business Operations",
      description: "Streamline internal processes and employee assistance",
      features: ["HR Inquiries", "IT Support", "Policy Information", "Meeting Scheduling"],
    },
  ]
          ...
          <div className="container mx-auto px-4">
            ...
            >
              <div className="space-y-4">
                <div className="flex justify-end">
                  <div className="bg-hacker-green/20 rounded-lg p-3 max-w-xs">
                    <p className="text-hacker-green-bright font-tech">Hi, I need help with my order</p>
                  </div>
                </div>
                ...
                <div className="flex justify-end">
                  <div className="bg-hacker-green/20 rounded-lg p-3 max-w-xs">
                    <p className="text-hacker-green-bright font-tech">#ORD12345</p>
                  </div>
                </div>
                ...
                <div className="flex justify-start">
                  <div className="bg-hacker-terminal rounded-lg p-3 max-w-xs border border-hacker-green">
                    <p className="text-hacker-green-bright font-tech">
                      Great! Order #ORD12345 was shipped yesterday and should arrive by tomorrow. Tracking:
                      TRK789456123. Is there anything else I can help you with?
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="text-center mt-6">
                <p className="text-hacker-green-dim font-tech">// This is how our AI responds in real-time</p>
              </div>
            </motion.div>
          </div>
        </section>
          ...
          <div className="container mx-auto px-4">
            <div className="glow-border rounded-lg p-12 bg-hacker-terminal/30 backdrop-blur-sm text-center">
              ...
              <p className="text-xl text-hacker-green-dim mb-8 max-w-2xl mx-auto">
                Start your AI chatbot journey today and revolutionize how you interact with customers.
              </p>
              <ContactButtons />
            </div>
          </div>
